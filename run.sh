...
elif [ "$EXP" == "mdp_double" ]; then
  python train_mdp.py --gpu=1 --no-bootstrap --heads=1 --num-steps=400000 --save-freq=10000 --batch-size=32 --learning-schedule=1.6 --epsilon-schedule=5 --target-update-freq=1000 --no-prioritized --save-dir="/scratch/r.chourasia/baselines_log/double/" "$@"
else
